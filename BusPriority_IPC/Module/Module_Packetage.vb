Module Module_Packetage
    ...
    Function Incode_Step1(ByVal seqNum As Integer, ByVal setPacket As String) As Byte() '需分辦 COMMAND OR ACK OR NAK
        Dim HighDevNumber As Byte() = StrToByteArray2(COMMON_EquipID.Substring(0, 2))
        Dim LowDevNumber As Byte() = StrToByteArray2(COMMON_EquipID.Substring(2, 2))
        Try
